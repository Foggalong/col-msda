...
$$
  \sum_{n=1}^{10} a_m = \frac{1}{2} \cdot n \cdot (1 + n) = \frac{n^2 + n}{2}.
$$
...
![Tiled squares representing the Fibonacci sequence, Romain (2022), CC-BY-SA.](https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Fibonacci_Squares.svg/640px-Fibonacci_Squares.svg.png){width=50%}
