...
::: {layout-ncol=2}
![Learn Page](img/learn.png){width=90%}

![Course Website](img/website.png){width=85%}
:::
...
::: {layout-ncol=2}
![Josh Fogg (Teacher)](img/josh.jpg){width=50%}

![Javiera Alfaro Chat (Course Organiser)](img/javiera.jpg){width=50%}
:::
...
::: {image}
![Full timetable for MSDA.](img/Stundenplan.PNG){width=100% alt="Lecture in Paterson's LG34 from 16:10-17:00 on Tuesdays and the three tutorial groups in St Leonard's 2.14 (9:00-10:50 for group A, 14:10-16:00 for group B, and 16:10-18:00 for group C) on Wednesdays."}
:::
...
::: {image}
![Example depiction of a function machine _(Bill Bailey, 2009)_.](img/Function_machine.png){width=20%}
:::
